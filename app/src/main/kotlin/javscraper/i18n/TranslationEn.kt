...
open class TranslationEn {
    ...
    open val settingsMoveOriginalVideo: String = "Move original video"
    ...
    open val videoFieldWantCount: String = "Want"
    open val videoFieldWatchedCount: String = "Watched"
    open val videoFieldRatingCount: String = "Ratings"
    open val videoFieldRankings: String = "Rankings"
    open val videoFieldReviews: String = "Reviews"
    open val videoReviewsCollapse: String = "Hide"
    open fun videoReviewsExpand(count: Int): String = "Show $count"
    open fun videoReviewScore(score: Double): String = "Score $score"
    open fun videoReviewLikes(likes: Int): String = "Likes $likes"
